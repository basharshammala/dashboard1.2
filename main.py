...
def about ():
    st.header('تعرف على تطبيق قمرة')
    text = "قمرة هي أداة تحليلات متقدمة على منصة زد، تمكّن أصحاب المتاجر من الحصول على رؤى شاملة حول أداء مبيعاتهم وسلوك عملائهم من خلال تحليل دقيق ومفصل للبيانات. توفر قمرة تحليلات مالية، وبيانات حول استخدام القسائم الشرائية، وأداء المنتجات، مما يساعد على اتخاذ قرارات تسويقية فعّالة. الأداة تم تصميمها خصيصًا لتحسين استراتيجية المبيعات وزيادة الأرباح عبر عرض معلومات حيوية وقابلة للتنفيذ."
    # for word in text.split(" "):
    #     yield word + " "
    #     time.sleep(0.05)
...
with right_col :
    st.image(r"C:\Users\HKH\Downloads\WhatsApp_Image_2025-10-13_at_8.25.26_PM-removebg-preview.png")
